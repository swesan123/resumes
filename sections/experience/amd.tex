...
% Prior active bullets (comment out; do not delete) — MAAS provisioning bullet added as first line for Canonical MAAS targeting:
% \resumeItem{Operated automated post-silicon validation on \textbf{Linux} datacenter GPU platforms for MI300X, MI325X, and MI350X, running integration passes across performance, IO, and platform quality at 100+ executions per week.}
% \resumeItem{Deployed and maintained \textbf{Linux} and Windows GPU lab configurations with varied BMC, BIOS, and OS images to stress RAS, resets, IO, performance, and system management, reducing early bring-up issues by about 20\%.}
...
% \resumeItem{Partnered with firmware and validation engineers across Jira and shared setup guides so teammates could repeat complex rack-style platform bring-up reliably in a distributed team environment.}
...
\resumeItem{Deployed and maintained \textbf{Linux} and Windows GPU lab configurations with varied BMC, BIOS, and OS images to stress RAS, IO, Performance, and System Management, reducing early bring-up issues by about 20\%.}
