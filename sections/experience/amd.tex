...
% \resumeItem{Extended \textbf{Python} automation and an internal workload launcher with version-tracked scripts, shrinking diagnostic setup from \textbf{about 20 minutes to under 5 minutes} per run because engineers reused the same canned launch paths.}
